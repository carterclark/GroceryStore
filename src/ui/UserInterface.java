...
public class UserInterface implements Serializable {
	...
	public void printTransactions() {
		...
		if (!userInput.toString().equals("END")) {
			...
			do {
				userInput = getString(
						"Input ending date. Ending date must succeed starting date chronologically. (mm/dd/yyyy format): ");
				if (userInput.equals("END")) {
					break;
				} else {
					// Try to parse user input as a Calendar object in the given format
					try {
						...
						if (endingDate.after(startingDate)) {
							...
							System.out.println(
									"Error: Ending date does not succeed starting date chronologically. Try again.");
						}
